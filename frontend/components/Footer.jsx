        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-400">
            <li className="flex items-start gap-3">
              ...
              54 Đường Số 28, Phường Bình Phú, Q6 TPHCM
            </li>
